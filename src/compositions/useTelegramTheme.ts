...
export const useTelegramTheme = (telegramWebApp: WebApp): GlobalThemeOverrides => {
  ...
  return {
    common: {
      ...
      opacity4: "0.38",
      opacity5: "0.28",
      dividerColor: themeParams.section_separator_color,
      borderColor: themeParams.section_separator_color,
      ...
      cardColor: themeParams.bg_color,
      modalColor: themeParams.secondary_bg_color,
      bodyColor: themeParams.secondary_bg_color,
      tagColor: "rgba(51, 51, 51, 1)",
      avatarColor: "rgba(255, 255, 255, 0.18)",
      invertedColor: "#000",
      inputColor: themeParams.bg_color,
